...
const About = () => {
  return (
    <div style={{ fontSize: "16px" }} lang="en">
      <section
        className="u-align-center-lg u-align-center-md u-align-center-xl u-align-left-sm u-align-left-xs u-clearfix u-section-1"
        id="carousel_6da5"
      >
        <div className="u-clearfix u-sheet u-valign-middle u-sheet-1">
          <h2 className="u-text u-text-1">Hello!</h2>
          ...
          <div className="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
            <div className="u-layout">
              <div className="u-layout-row">
                <div
                  className="u-container-style u-image u-image-round u-layout-cell u-radius-20 u-size-18-lg u-size-18-xl u-size-30-md u-size-30-sm u-size-30-xs u-image-1"
                  data-image-width="1000"
                  data-image-height="1045"
                >
                  <div className="u-container-layout u-valign-middle u-container-layout-1"></div>
                </div>
                <div className="u-container-style u-layout-cell u-size-22-lg u-size-22-xl u-size-30-md u-size-30-sm u-size-30-xs u-layout-cell-2">
                  <div className="u-container-layout u-container-layout-2">
                    <h4 className="u-text u-text-3">About me & website</h4>
                    <p className="u-text u-text-default u-text-4">
                    This is a blog website in which people can upload their
                    blogs depending on their category,tags and trending. In this
                    webapplication I used firbase for authentication and
                    database . Html ,Scass and React for front-end designing .I am a full
                    stack developer consentrated on MERN stack. I have a good
                    knowledge in React,Node js, Express js, MongoDB . I have good
                    communication skill and leadership qualities which I
                    obtained through leading many programs in university
                    level&nbsp;
                    </p>
                  </div>
                </div>
                <div className="u-container-style u-layout-cell u-size-20-lg u-size-20-xl u-size-60-md u-size-60-sm u-size-60-xs u-layout-cell-3">
                  <div className="u-container-layout u-container-layout-3">
                    <h4 className="u-text u-text-6">Details</h4>
    ...
    c-1.4,4.3-4.3,7.9-8.1,10.1c3.7-0.4,7.3-1.4,10.6-2.9C98.9,32.3,95.7,35.5,92.2,38.2z"
                      ...
                      <a
                        className="u-social-url"
                        title="instagram"
                        href="https://www.instagram.com/ali_sidq__"
                      >
